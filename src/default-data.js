export const defaultData = {
  summary:
    "Passionate software developer with experience in full-stack web development, backend API design, and AI research. Skilled in Python, JavaScript, React, Node.js, and Django. Adept at building scalable, maintainable applications and contributing to team projects from concept to deployment. Strong problem-solving skills and a commitment to continuous learning and innovation.",
